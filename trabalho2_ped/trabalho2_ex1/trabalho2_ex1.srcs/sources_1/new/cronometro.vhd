...
begin
    ...
    begin
        ...
        --ativa o switch de parada
        if btn_stop = '1'then 
            to_stop := '1';
            
            --se o switch de parada estiver desligado e o switch de start estiver ligado
            elsif btn_start = '1' and btn_stop = '0' then 
                to_stop := '0';
            --se o switch de reset estiver ligado e o switch de start desligado
        ...
        if rising_edge(clk) then
            ...
            if to_stop = '0' then
                ...
                --aumenta a unidade de segundo quando o count_segment chega em seu valor maximo
                if count_segment = 100000000 then
                    var_un_sec := var_un_sec + "0001";

                   --aumenta a dezena de segundo quando a unidade de segundo passa o 9
                    if var_un_sec > "1001" then
                        var_dec_sec := var_dec_sec + "001";
                        var_un_sec := "0000";

                        --aumenta a unidade de minuto quando a dezena de segundo passa o 5
                        if var_dec_sec > "101" then
                            var_min := var_min+"0001";
                            var_dec_sec := "000";

                            --volta o minuto para 0 quando o mesmo chega em 9
