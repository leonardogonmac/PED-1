...
## Switches
set_property PACKAGE_PIN V17 [get_ports {btn_start}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {btn_start}]
set_property PACKAGE_PIN V16 [get_ports {btn_stop}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {btn_stop}]
set_property PACKAGE_PIN W16 [get_ports {btn_reset}]					
...
#	set_property IOSTANDARD LVCMOS33 [get_ports btn_start]
#set_property PACKAGE_PIN T18 [get_ports btn_stop]						
#	set_property IOSTANDARD LVCMOS33 [get_ports btn_stop]
#set_property PACKAGE_PIN W19 [get_ports btn_reset]						
#	set_property IOSTANDARD LVCMOS33 [get_ports btn_reset]
